...
python -m multi.experiments.evaluate_dual_branch --checkpoint checkpoints/dual_branch_best_model.pt --split test
"""
import os
import sys
import yaml
...
from multi.experiments.rectangular_patch_vit import create_multi_shape_dual_branch_model
