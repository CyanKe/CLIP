...
python -m multi.experiments.train_dual_branch --config multi/config.yaml
...
from multi.experiments.rectangular_patch_vit import create_multi_shape_dual_branch_model, MultiShapePatchViTForDualBranch
