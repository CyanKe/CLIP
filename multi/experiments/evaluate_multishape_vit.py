...
用法:
  python -m multi.experiments.evaluate_multishape_vit --checkpoint checkpoints/multishape_vit_best.pt --mode zero_shot
  python -m multi.experiments.evaluate_multishape_vit --checkpoint checkpoints/multishape_vit_best.pt --mode by_jnr --visualize
"""
import os
import sys
import yaml
