...
d:\Anaconda\envs\clip\python.exe -m multi.umap_compare --checkpoint checkpoints/multishape_vit_best__model.pt --dataset test --jnr 0:1:20 --save-html --skip-pretrained
    python -m multi.umap_compare --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 10
    python -m multi.umap_compare --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 0:5:20
    python -m multi.umap_compare --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 0:5:20 --model-type multishape_vit
    python -m multi.umap_compare --checkpoint checkpoints/czsl_best_model.pt --dir D:/path/to/data --dataset test --jnr 0:1:10
