...
Usage:
  python -m multi.pca_attention --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 10 --n_samples_per_class 5
  python -m multi.pca_attention --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 0:1:20 --n_samples_per_class 10 --save-html
  python -m multi.pca_attention --checkpoint checkpoints/czsl_best_model.pt --dataset test --jnr 10 --n_samples_per_class 20 --save-html
